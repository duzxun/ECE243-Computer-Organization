...
KEY_ISR:        
				...
				LDR		R1, [R2, #0xC]  //get the value from Edgecapture
				MOV		R0, #0xF
...
KEY_0:			
				...
				BNE		KEY_1
				LDR		R3, =RUN
				LDR		R0, [R3]	//for KEY0 and KEY3 press load RUN value	
				EOR		R0, #1 		//flip the RUN value (on/off)
				B		KEY_SAME
...
KEY_1:	
				...
				LDR		R3, =0xFFFEC600 
				LDR		R0, [R3]	//get TIMER value
								
				LSR		R0, #1		//multiply speed by 2 (half frequency)
...
KEY_2:			
				...
				LSL		R0, #1		//divide speed by 2 (double frequency)
